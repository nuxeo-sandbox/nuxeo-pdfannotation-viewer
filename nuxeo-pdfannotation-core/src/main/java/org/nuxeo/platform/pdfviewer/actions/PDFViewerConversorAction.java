 ...
 */
@Name("ViewerConversor")
@Scope(ScopeType.EVENT)
public class PDFViewerConversorAction implements ConversionAction {

    private static final Log log = LogFactory.getLog(PDFViewerConversorAction.class);
